...
class EmpleadosController extends Controller
{
    ...
    public function create(Request $request)
    {
        $request->validate([
            ...
            'telefono2' => 'sometimes | required | string | regex:/^\d{10}$/',
            'email2' => 'sometimes | required | email',
            ...
            'enfermedades' => 'sometimes | required | string | max:300',
            'fonacot' => 'sometimes | required | string | max:15',
            ...
            'nomClave' => 'sometimes | required | string | max:10',
            'nomBanco' => 'sometimes | required | integer | min:0',
            'nomLocalidad' => 'sometimes | required | string | max:20',
            'nomReferencia' => 'sometimes | required | string | max:16',
            'nomCuenta' => 'sometimes | required | string | max:16',
    ...
    public function update($id, Request $request)
    {
        $request->validate([
            ...
            'estadoCivil' => 'sometimes | required | integer | between:1,6',
