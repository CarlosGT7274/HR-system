...
@section('content')
    ...
    <div class="flex flex-row">  
            <div id="Main" class="sticky top-0 xl:rounded-r transform xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start  w-full sm:w-64 bg-gray-900 flex-col h-[100vh]">
