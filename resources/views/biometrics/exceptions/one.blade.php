...
@section('inputs')
    <section class="w-5/6 md:w-2/3 xl:w-5/6 grid xl:grid-cols-2 gap-x-8 gap-y-8 mx-auto">
        ...
        <div class="flex flex-row items-center gap-2 p-2">
            ...
            <input type="datetime"  class="border-b-2 border-ldark cursor-default p-1 text-ldark flex-1" name="fecha_excep" readonly
                value="{{ $data['fecha_excep'] }}" id="name">
        </div>
        <div class="flex flex-row items-center gap-2 p-2">
            <label class="w-32" for="name">Fecha inicio: </label>
            <input type="datetime" class="border-b-2 border-ldark cursor-default p-1 text-ldark flex-1" name="tiempoini" readonly
                value="{{ $data['tiempoini'] }}" id="name">
        </div>
        <div class="flex flex-row items-center gap-2 p-2">
            <label class="w-32" for="name">Fecha termino: </label>
            <input type="datetime" class="border-b-2 border-ldark cursor-default p-1 text-ldark flex-1" name="tiempofin" readonly
        ...
        <div class="flex flex-row items-center gap-2 p-2">
            ...
            <input type="number" step='' min='0' max='' class="border-b-2 border-ldark cursor-default p-1 text-ldark flex-1" name="id_codpag" readonly
                value="{{ $data['id_codpago'] }}" id="name">
        </div>
        <div class="flex flex-row items-center gap-2 p-2">
            <label class="w-32" for="name">codigo del trabajador: </label>
            <input type="number" step='' min='0' max='' class="border-b-2 border-ldark cursor-default p-1 text-ldark flex-1" name="id_trabajador" readonly
